...
<html lang="en">
  ...
  <body>
      ...
      <div class="main">
        <div class="container">
            <h2 class="mt-5">Product List  -> <span class="text-warning">Bubur Madura Putri Ayu</span></h2>
            ...
            <div class="d-flex mt-5">
              <a href="/toko2/product/create"><input class="btn btn-warning" type="submit" value="Add New Product +"></a>
              ...
              <div class="col">
                <div class="card h-100">
                  <div class="card-body">
                    ...
                    <a href="/toko2/product/{{$product->id}}/edit"><button class="btn btn-success mt-3 mb-1">Update</button></a>
                    <form action="/toko2/product/{{ $product->id }}" method="POST" >
                      @csrf
                      @method("DELETE")
