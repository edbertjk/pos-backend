          ...
          <div class="col-12 col-md-8 col-lg-6 col-xl-5">
            <div class="card shadow-2-strong" style="border-radius: 1rem;">
              <div class="card-body p-5 text-center">
                  ...
                  <form action="/toko2/product" method="POST">
                    @csrf
                    ...
                    <input type="number" class="form-control form-control-lg" value="0" name="jumlah"  />
                    </div>          

                    <div class="form-outline mb-4">
                    <label class="form-label">Harga Beli</label>
                    <input type="text" class="form-control form-control-lg" value="0" name="harga_beli"/>
                    </div>
                
                    <div class="form-outline mb-4">
                    <label class="form-label">Harga Jual</label>
                    <input type="text" class="form-control form-control-lg" value="0" class="border border-2" name="harga_jual" />
                    </div>
