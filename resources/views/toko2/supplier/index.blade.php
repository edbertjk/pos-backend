...
<html lang="en">
  ...
  <body>
      ...
      <div class="main">
        <div class="container">
            <h2 class="mt-5">Supplier List  -> <span class="text-warning">Bubur Madura Putri Ayu</span></h2>
            ...
            <div class="d-flex mt-5">
              <a href="/toko2/suppliers/create"><input class="btn btn-warning" type="submit" value="Add New Supplier +"></a>
              <a href="/toko2/product" ><input class="btn btn-primary me-2 ms-4" type="submit" value="Go Product List ->"></input></a>
              <a href="/toko2/categories" ><input class="btn btn-primary me-2 ms-2" type="submit" value="Go Category List ->"></input></a>
            </div>
              ...
              <div class="col">
                <div class="card h-100">
                  <div class="card-body">
                    ...
                    <a href="/toko2/suppliers/{{$supplier->id}}/edit"><button class="btn btn-success mt-3 mb-1">Update</button></a>
                    <form action="/toko2/suppliers/{{ $supplier->id }}" method="POST" >
                      @csrf
                      @method("DELETE")
